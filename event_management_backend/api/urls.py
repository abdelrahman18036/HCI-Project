...
from .views import (
    CommentListCreateView, EventAttendeesListView, OrganizerAnalyticsView, SignupView, LoginView,
...
urlpatterns = [
    ...
    path('organizer/analytics/', OrganizerAnalyticsView.as_view(), name='organizer-analytics'),  # New route
